...
class FinanceApp:
    ...
    # Get user Input. Print the menu once
        ...
        while True:
            ...
            if user_input == 1:     # Go to Journal Section
                self.journal()
                break
            elif user_input == 2:   # Go to TB Section
                self.accounts(type='tb')
                break
            elif user_input == 3:   # Go to CoA Section
                self.accounts(type='coa')
                break
            elif user_input == 4:   # Go to Balance Sheet

                break
            elif user_input == 5:   # Go to Cash Flow

                break
            elif user_input == 6:   # Go to Ledger options
                while True:
                    print(self.sl_menu)
                ...
                break
            elif user_input == 7:   # Go to Journal Section

                break            
            elif user_input == 8:   # Go to Journal Section
